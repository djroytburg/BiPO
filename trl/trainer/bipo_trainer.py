        ...
        with PartialState().local_main_process_first():
            ...
            if eval_dataset is not None:
                if isinstance(eval_dataset, dict):
                    eval_dataset = {'test_dataset_add': eval_dataset['test_dataset_add'].map(self.tokenize_row, num_proc=self.dataset_num_proc, writer_batch_size=10), 'test_dataset_sub': eval_dataset['test_dataset_sub'].map(self.tokenize_row, num_proc=self.dataset_num_proc, writer_batch_size=10)}
                else:
